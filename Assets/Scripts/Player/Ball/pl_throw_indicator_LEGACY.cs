...
public class pl_throw_indicator_LEGACY : MonoBehaviour
{
    ...
    {
        //float currentLerpFactor = currentCharge / refs.settings.ballThrow.chargeCounterMax;
        float currentLerpFactor = currentCharge / 64;
